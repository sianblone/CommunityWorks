	...
	<section class="container-fluid">
		<fieldset>
			...
			<div class="form-group">
				<input name="g_writer" class="form-control" 
						placeholder="작성자" value="${GALLERY.g_writer}">
			</div>
			<div class="form-group">
				<input name="g_subject"  class="form-control" 
					placeholder="제목" value="${GALLERY.g_subject}">
			</div>
			<div class="form-group">
				<textarea name="g_content" id="g_content" rows="5" cols="30">${GALLERY.g_content}</textarea>
			</div>
